...
import com.risetek.auth.client.application.app.editor.DescriptionEditorView;
...
public class AppModule extends AbstractPresenterModule {
	...
	protected void configure() {
		...
		bindSingletonPresenterWidget(DescriptionEditorPresenter.class, DescriptionEditorPresenter.MyView.class,
				DescriptionEditorView.class);
	}
}
