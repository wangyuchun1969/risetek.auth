...
public class LoginWidget extends SimplePanel {
	...
	public LoginWidget(LoginSubmitHandle submithandler) {
		...
		Image user_img = new Image(LoginBundle.resources.user_png());
		...
		usernameInputBox.getElement().setPropertyString("placeholder", "请输入用户名");
		...
		Image password_img = new Image(LoginBundle.resources.password_png());
		...
		passwordInputBox.getElement().setPropertyString("placeholder", "请输入密码");
